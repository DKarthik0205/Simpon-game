...
function playsound2() {
  let sound = new Audio('../Simpon-game/sound/victory.mp3');
  sound.play();
}
function green() {
  let sound = new Audio('../Simpon-game/sound/1.mp3');
  sound.play();
}

function red() {
  let sound = new Audio('../Simpon-game/sound/2.mp3');
  sound.play();
}

function blue() {
  let sound = new Audio('../Simpon-game/sound/3.mp3');
  sound.play();
}

function yellow() {
  let sound = new Audio('../Simpon-game/sound/4.mp3');
  sound.play();
}
function playsound() {
  let sound = new Audio('../Simpon-game/sound/wrong.mp3');
  sound.play();
}
